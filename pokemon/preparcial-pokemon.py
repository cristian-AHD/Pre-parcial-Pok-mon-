...
pokemons = [
    ...
    pokemon(id=25, nombre="Pikachu", life=35, attack=55, type="electrico"),
    ...
    pokemon(id=483, nombre="Giratina", life=145, attack=135, type="siniestro/dragon"),
    ...
    pokemon(id=384, nombre="Rayquaza", life=115, attack=150, type="dragon/volador"),
    pokemon(id=383, nombre="Groudon", life=100, attack=150, type="Tierra"),
    pokemon(id=383, nombre="Kyogren", life=100, attack=150, type="agua"),
    pokemon(id=133, nombre="Eevee", life=55, attack=55, type="normal"),
    ...
    pokemon(id=282, nombre="Gardevoir", life=68, attack=65, type="psiquico"),
